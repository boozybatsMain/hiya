...
async function saveHandoff(req, data) {
  ...
  const doc = {
    ...
    ft_medium: String(data.ft_medium || '').slice(0, 100),
    ft_campaign: String(data.ft_campaign || '').slice(0, 200),
    ft_content: String(data.ft_content || '').slice(0, 200),
    ft_term: String(data.ft_term || '').slice(0, 200),
    ft_campaign_id: String(data.ft_campaign_id || '').slice(0, 100),
    ft_adset_id: String(data.ft_adset_id || '').slice(0, 100),
    ft_ad_id: String(data.ft_ad_id || '').slice(0, 100),
